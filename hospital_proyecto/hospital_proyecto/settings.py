"""
Django settings for hospital_proyecto project.
...
SECRET_KEY = 'django-insecure-^rl7$yauk!=2!w0qm$t+58u2tz$%vv_^h-b8mxk&ps9m9iaieq'
...
ROOT_URLCONF = 'hospital_proyecto.urls'
...
WSGI_APPLICATION = 'hospital_proyecto.wsgi.application'
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'doctores/static/uploads')
